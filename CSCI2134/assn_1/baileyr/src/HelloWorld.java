...
public class HelloWorld {
    ...
    private static final String bannerNumber = "B00889782";

    // replace ???? with your csid (e.g., abrodsky)
    private static final String csid = "baileyr";

    // replace ???? with your last name (e.g., Brodsky)
    private static final String lastName = "Rutherford";

    // replace ???? with your last name (e.g., Alex)
    private static final String firstName = "Bailey";
