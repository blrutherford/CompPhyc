...
public class FriendRecommender {
  ...
  public void makeInterestRecommendations(User u, ArrayList<String> al){
    Interest interest = u.getInterest();
    if( interest == null ) {
      return;
    }
    for(User v: User.users.values()){
      if(v.getInterest() != null && (u != v) && v.getInterest().equals(interest) && !u.isFriend( v )) {
